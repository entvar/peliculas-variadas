...
function generateMetaTags(post, siteConfig, isHome = false) {
    ...
    if (isHome) {
        return `
    <meta name="description" content="${siteConfig.name}. Reseñas, noticias y análisis del mejor cine.">
    <meta name="keywords" content="${siteConfig.category.toLowerCase()}, cine, reseñas, noticias, estrenos, películas">
    <meta property="og:title" content="${siteConfig.name}">
    <meta property="og:description" content="${siteConfig.name}. Reseñas, noticias y análisis del mejor cine.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="${baseUrl}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="${siteConfig.name}">
    <meta name="twitter:description" content="${siteConfig.name}. Reseñas, noticias y análisis del mejor cine.">`;
    }
    
    return `
    <meta name="description" content="${post.summary || post.title}">
    <meta name="keywords" content="${post.category}, ${post.title}, ${siteConfig.category.toLowerCase()}, reseñas">
...
async function generateHomePage(posts, siteConfig) {
    ...
    const postsList = posts.map(post => `
        <article class="post-preview">
            ...
            <div class="post-content">
                ...
                <a href="${siteConfig.baseUrl}/${post.slug}" class="read-more">Leer más →</a>
            </div>
        </article>
    `).join('');
    ...
    const content = `
        <section class="hero">
            ...
            <p>Reseñas, noticias y análisis del mejor ${siteConfig.category.toLowerCase()}</p>
        </section>
    ...
    const html = template
        ...
        .replace(/\{\{CURRENT_PAGE === 'home' \? '/' : '/' \+ CURRENT_PAGE\}\}/g, '/')
        .replace(/\{\{CURRENT_PAGE === 'category' && CATEGORY === 'peliculas' \? 'active' : ''\}\}/g, '')
        .replace(/\{\{CURRENT_PAGE === 'category' && CATEGORY === 'series' \? 'active' : ''\}\}/g, '');
